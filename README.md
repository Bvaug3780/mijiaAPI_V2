...
本项目基于 [Do1e/mijia-api](https://github.com/Do1e/mijia-api) 进行重构和现代化改造。感谢原作者 Do1e 的开创性工作，为米家智能家居的Python生态做出了重要贡献。

本重构版本在保持核心功能的基础上，采用了现代化的架构设计和工程实践，旨在提供更好的开发体验和可维护性。
